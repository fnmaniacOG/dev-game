...
declare_id!("HdsUUMJYq5UYnXKdHn3PDYMWENH1EfG3YjwG7DyidKsB");
...
pub mod game_state {
    ...
    pub fn register_game(
        ...
        game.name[..nc].copy_from_slice(&nb[..nc]);
    ...
    pub fn claim_stake_yield(ctx: Context<ClaimStakeYield>) -> Result<()> {
        ...
        // K-02 fix: divide before multiply to prevent u64 overflow
        // staked * bps / 10000 * nft / 10000 * epochs
